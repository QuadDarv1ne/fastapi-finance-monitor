...
from app.models import Portfolio, PortfolioItem, User, Watchlist, WatchlistItem
...
class DatabaseService:
    ...
    def update_user(self, user_id: int, email: str | None = None) -> User | None:
    ...
    def add_to_watchlist(
        self, watchlist_id: int, symbol: str, name: str, asset_type: str
    ) -> WatchlistItem:
        ...
        try:
            ...
            # Create new item
            item = WatchlistItem(
                watchlist_id=watchlist_id, symbol=symbol, name=name, asset_type=asset_type
            )
    ...
    def remove_from_portfolio(self, portfolio_id: int, symbol: str) -> bool:
        ...
        try:
            item = (
                ...
                .filter(
                    and_(PortfolioItem.portfolio_id == portfolio_id, PortfolioItem.symbol == symbol)
                )
                .first()
            )
