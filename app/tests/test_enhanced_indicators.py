...
def test_all_indicators_enhanced():
    ...
    close_prices = pd.Series(
        [100, 102, 101, 103, 105, 104, 106, 108, 107, 109, 110, 112, 111, 113, 115]
    )
    high_prices = pd.Series(
        [101, 103, 102, 104, 106, 105, 107, 109, 108, 110, 111, 113, 112, 114, 116]
    )
    low_prices = pd.Series(
        [99, 101, 100, 102, 104, 103, 105, 107, 106, 108, 109, 111, 110, 112, 114]
    )
    volume = pd.Series(
        [1000, 1200, 800, 1500, 1100, 900, 1300, 1600, 1400, 1200, 1100, 1300, 1000, 1400, 1500]
    )

    # Create DataFrame
    df = pd.DataFrame(
        {"Close": close_prices, "High": high_prices, "Low": low_prices, "Volume": volume}
    )
