...
def test_user_registration_duplicate_username():
    ...
    response = client.post(
        "/api/users/register",
        json={"username": "testuser2", "email": "test3@example.com", "password": "TestPass123!"},
    )
...
def test_user_registration_duplicate_email():
    ...
    client.post(
        "/api/users/register",
        json={"username": "testuser3", "email": "test4@example.com", "password": "TestPass123!"},
    )

    # Second registration with same email
    response = client.post(
        "/api/users/register",
        json={"username": "testuser4", "email": "test4@example.com", "password": "TestPass123!"},
    )
